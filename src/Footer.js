    ...
    return (
        <footer className="app-footer">
            <div className="bmc-container">
                ...
                <a href="https://www.buymeacoffee.com/javigd"><img alt="Buy me a coffee!" src={`https://img.buymeacoffee.com/button-api/?text=${strings.buymecoffee}&emoji=☕&slug=javigd&button_colour=c3c60c&font_colour=ffffff&font_family=Cookie&outline_colour=ffffff&coffee_colour=ffffff`} /></a>
            </div>
